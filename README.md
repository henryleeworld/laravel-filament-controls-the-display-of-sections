# Laravel 12 Filament 控制各區段的顯示

Filament 控制各區段的顯示採用快速建立簡捷的 TALL（Tailwind CSS、Alpine.js、Laravel 和 Livewire）堆疊應用程式的工具組，每個區段都可以設定成隱藏或是顯示。
...
## 畫面截圖
![](https://i.imgur.com/M3IymV9.png)
> 控制首頁區段的顯示

![](https://i.imgur.com/HIrEzSm.png)
> 隱藏區段不會顯示在首頁
